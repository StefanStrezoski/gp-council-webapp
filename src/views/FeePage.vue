    ...
    <base-card>
      ...
      <paragraph-no-indent class="text-center">
        <b style="color: #125280">
          Висината на цената за секоја категорија, <span class="text-red"> ќе се пресметува според <br/>
      ...
      <paragraph-no-indent class="text-center">
        <b>
          НАПОМЕНА за категоријата &#11088;&#11088;&#11088;: СИТЕ УЧЕСНИЦИ КОИ <span class="text-red">ИМААТ ПЛАТЕНО КОТИЗАЦИЈА, <br/> A НЕ СЕ СМЕСТЕНИ ВО ХОТЕЛ ДРИМ,</span> ЗА ПРИСУСТВО НА СВЕЧЕНИТЕ ВЕЧЕРИ <span class="text-red"> <br/> АВАНСНО ДОПЛАЌААТ 45 € ПО ЧОВЕК, ЗА СЕКОЈА ВЕЧЕРА ПОСЕБНО.</span>
        </b>
      </paragraph-no-indent>
      <paragraph-no-indent class="text-center mb-10">
        <b>
          СИТЕ УЧЕСНИЦИ КОИ <span class="text-red">НЕМААТ ПЛАТЕНО КОТИЗАЦИЈА И НЕ СЕ СМЕСТЕНИ ВО ХОТЕЛ ДРИМ,</span> <br/>
